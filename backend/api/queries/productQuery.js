exports.get_all = `SELECT p.id,p.name,p.price,p.description,p.stockinusa,p.unit,p.moq,s.name as catgeory,c.name as maincategory,p.images,p.certificates,p.country,p.rating,p.incoterms,x.name as supplier,x.standards
                FROM products p 
